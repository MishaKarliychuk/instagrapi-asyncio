...
class AsyncMediaMixin(MediaMixin):
    """
    Async helpers for media
    """
    ...
    async def media_info_gql(self, media_pk: str) -> Media:
        ...
        if data["shortcode_media"]["location"] and self.authorization:
            data["shortcode_media"]["location"] = (await self.location_complete(
    ...
    async def user_videos_paginated_v1(self, user_id: int, amount: int = 50, end_cursor: str = "") -> Tuple[List[Media], str]:
        """
    ...
    async def user_clips_paginated_v1(self, user_id: int, amount: int = 50, end_cursor: str = "") -> Tuple[List[Media], str]:
        """
    ...
    async def user_clips(self, user_id: int, amount: int = 0) -> List[Media]:
        """
