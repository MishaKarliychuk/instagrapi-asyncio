...
class AsyncHashtagMixin(HashtagMixin):
    """
    Async helpers for managing Hashtag
    """
    ...
    async def hashtag_medias_v1(
        ...
        List[Media]
            List of objects of Media
        """
        medias, _ = await self.hashtag_medias_v1_chunk(name, amount, tab_key)
        if amount:
            medias = medias[:amount]
        return medias
    ...
    async def hashtag_medias_top_a1(self, name: str, amount: int = 9) -> List[Media]:
        ...
        List[Media]
            List of objects of Media
        """
        return await self.hashtag_medias_a1(name, amount, tab_key="edge_hashtag_to_top_posts")
    ...
    async def hashtag_medias_recent_a1(self, name: str, amount: int = 71) -> List[Media]:
        ...
        List[Media]
            List of objects of Media
        """
        return await self.hashtag_medias_a1(name, amount, tab_key="edge_hashtag_to_media")
