...
from ..mixins.location import tab_keys_a1, tab_keys_v1, LocationMixin


class AsyncLocationMixin(LocationMixin):
    """
    Async helper class to get location
    """
    ...
    async def location_info(self, location_pk: int) -> Location:
        ...
        """
        try:
            location = await self.location_info_a1(location_pk)
        except Exception:
            ...
            location = await self.location_info_v1(location_pk)
        return location
    ...
    async def location_medias_a1_chunk(
        ...
        while True:
            ...
            for edge in edges:
                ...
                medias.append(await self.media_info_gql(media_pk))
    ...
    async def location_medias_top(
        ...
        """
        try:
            return await self.location_medias_top_a1(location_pk, amount, sleep)
        except Exception:
            # Users do not understand the output of such information and create bug reports
            # such this - https://github.com/adw0rd/instagrapi/issues/364
            # if not isinstance(e, ClientError):
    ...
    async def location_medias_recent(
        ...
        """
        try:
            return await self.location_medias_recent_a1(location_pk, amount, sleep)
        except Exception:
            # Users do not understand the output of such information and create bug reports
            # such this - https://github.com/adw0rd/instagrapi/issues/364
            # if not isinstance(e, ClientError):
            #     self.logger.exception(e)
            return await self.location_medias_recent_v1(location_pk, amount)
